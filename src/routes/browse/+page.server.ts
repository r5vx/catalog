import { searchAll, browseShelves, hasTmdbKey } from '$lib/server/metadata';
...
export const load: PageServerLoad = async ({ url }) => {
	...
	return {
		...
		// wait on three trending lists it won't show.
		shelves: q ? [] : await browseShelves(category || undefined),

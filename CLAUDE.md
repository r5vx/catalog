...
- Streaming or downloading pirated video. Asked for and declined; the answer
  did not change on a second ask. **Where to watch** (TMDB/JustWatch
  availability) is the version of that which exists.
